                        ...
                        <div class="accordion gray plus-icon round">
                            ...
                            @foreach ($Grades as $Grade)
                                ...
                                <div class="acd-group">
                                    ...
                                    @else
                                    <a href="#" class="acd-heading">{{ $Grade->Name_en }}</a>
                                    @endif
                                    <div class="acd-des">
                                                                ...
                                                                @foreach ($Grade->Sections as $list_Sections)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $list_Sections->Name }}</td>
                                                                                                    @else
                                                                                                        <td>{{ $list_Sections->Name_en }}</td>
                                                                                                    
                                                                                                    @endif
                                                                        @if (App::getLocale() == 'ar')
                                                                        <td>{{ $list_Sections->My_classs->Name}}
                                @else
                                <td>{{ $list_Sections->My_classs->Name_en }}
                                @endif
                                                                        </td>
                                                                        <td>
                                                                                        ...
                                                                                        <div class="col">
                                                                                            ...
                                                                                            <select name="Class_id"
                                                                                                ...
                                                                                                <option
                                                                                                    ...
                                                                                                    @else
                                                                                                        {{ $list_Sections->My_classs->Name_en }}
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="{{ route('Sections.store') }}" method="POST">
                                        ...
                                        @foreach ($list_Grades as $list_Grade)
                                            <option value="{{ $list_Grade->id }}"> {{ $list_Grade->Name_en }}
                                            </option>
                                        @endforeach
                                    </select>
                                            @endif
                                        ...
                                        <div class="col">
                                            ...
                                            <select name="Class_id" class="custom-select">
                                                ...
                                                @foreach ($Classrooms as $Class)
                                                    <option value="{{ $Class->id }}"> {{ $Class->Name_en }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @endif
